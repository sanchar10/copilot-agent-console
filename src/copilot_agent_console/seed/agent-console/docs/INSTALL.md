...
pipx install https://github.com/sanchar10/copilot-agent-console/releases/download/v0.4.0/copilot_agent_console-0.4.0-py3-none-any.whl
```
...
```powershell
pip install https://github.com/sanchar10/copilot-agent-console/releases/download/v0.4.0/copilot_agent_console-0.4.0-py3-none-any.whl
```
