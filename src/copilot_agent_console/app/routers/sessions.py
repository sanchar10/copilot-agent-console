...
from copilot_agent_console.app.config import SESSIONS_DIR
...
from copilot_agent_console.app.services.logging_service import get_logger, set_session_context
