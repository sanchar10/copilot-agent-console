...
from copilot_console.app.services.ralph_storage import get_ralph_storage
...
from copilot_console.app.services.logging_service import get_logger, set_ralph_context
...
class RalphService:
    ...
    async def get_job_history(self, run_id: str, job_id: str) -> dict | None:
        ...
        from copilot_console.app.services.session_service import read_raw_events
