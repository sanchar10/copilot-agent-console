      ...
      <div className="relative flex-1 min-h-0">
        ...
        {showScrollButton && (
          <button
            ...
            className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-gray-800 text-white px-3 py-1.5 rounded-full shadow-lg text-sm flex items-center gap-1.5 hover:bg-gray-700 transition-colors z-10"
          >
            ↓ New messages
          </button>
        )}
