        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-3 bg-gray-50/95 dark:bg-gray-800/95 border-b border-qd-border-soft z-10">
            ...
            <div className="flex items-center gap-2">
              {/* Modal zoom controls */}
              <div className="flex items-center gap-1 mr-2 border-r border-qd-border pr-2">
                <button
                  onClick={() => setModalZoom(z => Math.max(0.25, z - 0.25))}
                  disabled={modalZoom <= 0.25}
                  className="p-1.5 text-qd-text-muted hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors disabled:opacity-40"
                  title="Zoom out"
                >
                ...
                <span className="text-sm text-qd-text-muted min-w-[3.5rem] text-center">{Math.round(modalZoom * 100)}%</span>
                <button
              ...
              <button
                onClick={() => setIsFullscreen(false)}
                className="p-1.5 text-qd-text-muted hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors"
                title="Close (Esc)"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-1">
            ...
            {!showRaw && (
              <div className="flex items-center gap-1 mr-2 border-r border-qd-border pr-2">
                <button
                  ...
                  disabled={zoom <= 0.25}
                  className="p-1 text-qd-text-muted hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  title="Zoom out"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM13 10H7" />
                ...
                <span className="text-xs text-qd-text-muted min-w-[3rem] text-center">{Math.round(zoom * 100)}%</span>
                <button
                ...
                <button
                  onClick={() => setZoom(1)}
                  disabled={zoom === 1}
                  className="p-1 text-xs text-qd-text-muted hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  title="Reset zoom"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            ...
            {!showRaw && (
              <button
                ...
                className="p-1 text-qd-text-muted hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors mr-1"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 text-xs text-qd-text-muted hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors"
            >
              {showRaw ? (
                <>
