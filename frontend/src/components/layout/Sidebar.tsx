...
export function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-[#1a2332]/95 backdrop-blur-xl border-r border-gray-600/40 shadow-sm text-gray-100 flex flex-col overflow-y-auto">
      {/* Header - sticky at top */}
      <div className="sticky top-0 bg-[#1a2332]/95 backdrop-blur-xl p-4 border-b border-gray-600/40 z-10">
      ...
      <div className="sticky bottom-0 p-4 border-t border-gray-600/40 bg-[#1a2332]/90 backdrop-blur">
        <button
