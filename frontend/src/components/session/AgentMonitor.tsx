    ...
    <div className="bg-qd-bg-elev backdrop-blur rounded-lg p-4 border border-qd-border-soft dark:border-qd-border">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-qd-text">
            {session.session_id.slice(0, 8)}...
          </span>
        </div>
        <div className="flex items-center gap-3 text-xs text-qd-text-muted">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {data.count === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-qd-text-muted">No agents currently running</p>
              <p className="text-qd-text-muted text-sm mt-1">
